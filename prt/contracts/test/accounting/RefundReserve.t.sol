...
contract RefundReserveTest is Test {
    ...
    function testCurrentBondPolicyCheckpoint() public {
        ...
        assertEq(terminal, 948_000);
        assertEq(Bond.actionRefundCap(Gas.WIN_LEAF_MATCH), 0.04215 ether);
        assertEq(Bond.matchWorkAllocation(48), 6_823_000);
        assertEq(Bond.matchWorkAllocation(17), 2_948_000);
        assertEq(Bond.matchWorkAllocation(27), 4_198_000);
        assertEq(Bond.matchWorkAllocation(55), 7_698_000);
        assertEq(Bond.matchWorkAllocation(37), 5_448_000);
        assertEq(Bond.bondValue(48), 0.34115 ether);
        assertEq(Bond.bondValue(17), 0.1474 ether);
        assertEq(Bond.bondValue(27), 0.2099 ether);
        assertEq(Bond.bondValue(55), 0.3849 ether);
        assertEq(Bond.bondValue(37), 0.2724 ether);
