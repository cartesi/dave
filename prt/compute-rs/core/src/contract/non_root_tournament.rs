...
pub mod non_root_tournament {
                ...
                (
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::Function {
                            ...
                            outputs: ::std::vec![
                                ::ethers::core::abi::ethabi::Param {
                                    name: ::std::borrow::ToOwned::to_owned("_max_level"),
    ...
    impl ::core::convert::From<EliminateMatchByTimeoutCall> for NonRootTournamentCalls {
    ...
    pub struct InnerTournamentWinnerReturn(pub bool, pub [u8; 32], pub [u8; 32]);
