...
mod tests {
    ...
    #[test]
    fn test_is_pow2() {
        assert!(crate::merkle::tree_builder::is_count_pow2(U256::from(0)));
        assert!(crate::merkle::tree_builder::is_count_pow2(U256::from(1)));
        assert!(crate::merkle::tree_builder::is_count_pow2(U256::from(2)));
        assert!(!crate::merkle::tree_builder::is_count_pow2(U256::from(3)));
        assert!(crate::merkle::tree_builder::is_count_pow2(U256::from(4)));
        assert!(!crate::merkle::tree_builder::is_count_pow2(U256::from(5)));
    }
