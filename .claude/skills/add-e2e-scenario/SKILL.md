...
description: Add or wire a new e2e test scenario for the PRT rollups harness (test/e2e/rollups). Use when creating a scenario, adding a sybil scenario, or wiring an existing scenario into suites, CI, or the battery.
---
