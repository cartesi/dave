...
pub mod non_root_tournament {
        ...
        ::ethers::core::abi::ethabi::Contract {
            ...
            functions: ::core::convert::From::from([
                ...
                (
                    ...
                    ::std::vec![::ethers::core::abi::ethabi::Function {
                        name: ::std::borrow::ToOwned::to_owned("innerTournamentWinner",),
                        inputs: ::std::vec![],
                        outputs: ::std::vec![
                            ::ethers::core::abi::ethabi::Param {
                                name: ::std::string::String::new(),
    ...
    pub static NONROOTTOURNAMENT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> NonRootTournament<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, NonRootTournamentEvents>
        {
            self.0
    ...
    impl ::ethers::core::abi::AbiDecode for NonRootTournamentCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <InnerTournamentWinnerCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::core::fmt::Display for NonRootTournamentCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::InnerTournamentWinner(element) => ::core::fmt::Display::fmt(element, f),
