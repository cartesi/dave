...
pub mod root_tournament {
    ...
    pub static ROOTTOURNAMENT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> =
    ...
    impl<M: ::ethers::providers::Middleware> RootTournament<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, RootTournamentEvents>
        {
            self.0
    ...
    impl ::ethers::core::abi::AbiDecode for RootTournamentCalls {
        fn decode(
            ...
            if let Ok(decoded) =
                <ArbitrationResultCall as ::ethers::core::abi::AbiDecode>::decode(data)
            {
    ...
    impl ::ethers::core::abi::AbiEncode for RootTournamentCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                ...
                Self::ArbitrationResult(element) => ::ethers::core::abi::AbiEncode::encode(element),
